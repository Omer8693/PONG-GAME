...
def train_expected_sarsa(complex_mode=False):
    ...
    episode_rewards = []
    num_episodes = Constants.total_timesteps // 300  # varsayım: ortalama 300 adım/episode
...
if __name__ == "__main__":
    train_expected_sarsa(complex_mode=False)  # Simple mode
    train_expected_sarsa(complex_mode=True)   # Complex mode
...
def train_expected_sarsa(complex_mode=False):
    ...
    try:
        for episode in range(num_episodes):
            ...
            step_count = 0
            max_steps = 1000  # maksimum adım limiti
